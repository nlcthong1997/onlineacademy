...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 19, 2020 at 04:39 PM
...
(1, 'Lập trình Web', NULL),
(2, 'Lập trình di động', NULL);
...
INSERT INTO `courses` (`id`, `categories_id`, `slides_id`, `videos_id`, `title`, `name`, `teacher`, `point_evaluate`, `qty_student_evaluate`, `qty_student_registed`, `img`, `img_large`, `price`, `price_promo`, `sort_desc`, `detail_desc`, `status`) VALUES
(1, 1, NULL, NULL, 'Khóa học lập trinh Web từ cơ bản đến nâng cao', 'Lập trình NodeJS', 'Nguyễn Văn A', NULL, 16, 5, NULL, NULL, '3400000', NULL, 'Khóa học dành cho người mới bắt đầu', NULL, 'not_done'),
(2, 1, NULL, NULL, 'Khóa học lập trinh Web từ cơ bản đến nâng cao', 'Lập trình PHP', 'Nguyễn Văn B', NULL, 12, 8, NULL, NULL, '3000000', NULL, 'Khóa học dành cho người mới bắt đầu', NULL, 'not_done'),
(3, 2, NULL, NULL, 'Khóa học lập trinh di động từ cơ bản đến nâng cao', 'Lập trình Android', 'Nguyễn Văn C', NULL, 12, 6, NULL, NULL, '3750000', NULL, 'Khóa học dành cho người mới bắt đầu', NULL, 'not_done'),
(4, 2, NULL, NULL, 'Khóa học lập trinh Web từ cơ bản đến nâng cao', 'Lập trình IOS', 'Nguyễn Văn D', NULL, 7, 3, NULL, NULL, '4100000', NULL, 'Khóa học dành cho người mới bắt đầu', NULL, 'not_done');
...
ALTER TABLE `courses`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `courses` ADD FULLTEXT KEY `title` (`title`);
